...
function Footer({userInput, setCompare, AIChecker, compareOutputs, score, sideNavTitles, nextChallenge, outputDetails, solutionOutputDetails}) {
  return (
    <div 
        style={{
          width: "100%", 
